    ...
    metrics: [
      {
        ...
        tone: "cyan",
        description: "Накопленные evidence-backed утверждения из demo scenarios.",
      },
      {
        label: "Confirmed",
        value: String(statusCount("confirmed")),
        tone: "green",
        description: "High confidence claims без явных conflicts или gaps.",
      },
      {
        label: "Weakly supported",
        value: String(statusCount("weakly_supported")),
        tone: "amber",
        description: "Claims со средней или низкой уверенностью.",
      },
      {
        label: "Needs review",
        value: String(statusCount("needs_review") + statusCount("conflicting")),
        tone: "red",
        description: "Claims, связанные с contradiction или knowledge gap.",
      },
      {
        label: "Unique sources",
        value: String(uniqueSources.size),
        tone: "violet",
        description: "Уникальные source references в базе утверждений.",
      },
      {
        label: "Materials",
        value: String(uniqueMaterials.size),
        tone: "cyan",
        description: "Уникальные материалы в claims.",
      },
      {
        label: "Processes",
        value: String(uniqueProcesses.size),
        tone: "slate",
        description: "Уникальные процессы в claims.",
      },
      {
        label: "Average confidence",
        value: getAverageConfidence(claims),
        tone: "green",
        description: "Нормированная уверенность по всем claims.",
      },
    ],
